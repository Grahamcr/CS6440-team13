...
public class EncounterTypeDF {
    ...
    public EncounterTypeDF(EncounterType e) {
		super();
		this.templateId = e.getTemplateId();
		this.id = e.getId();
		if(e.getCode() != null) {
			this.code = new CodeTypeDF(e.getCode());
		}
		this.statusCode = e.getStatusCode();
		if(e.getEffectiveTime() != null) {
			this.effectiveTime = new EffectiveTimeTypeDF(e.getEffectiveTime());
		}
		this.classCode = e.getClassCode();
		this.moodCode = e.getMoodCode();
	}
     ...
     *     
     */
    public void setCodeDF(CodeTypeDF value) {
        this.code = value;
    }
